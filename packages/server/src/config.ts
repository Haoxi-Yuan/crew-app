...
export const INSTALL_DIR = _cfg.server.installDir;
...
export const MCP_BRIDGE_PATH = _cfg.server.mcpBridgePath;
export const MCP_TOOL_MEMORY_PATH = _cfg.server.mcpToolMemoryPath;
